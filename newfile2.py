...
async def mass_check_task_ultrafast(user_id, cards, status_msg, chat_id, context):
    ...
    try:
        ...
        for i, card in enumerate(cards):
            ...
            # Check if this was an actual decline (not an error)
            is_actual_decline = (status == "declined" and 
                                "error" not in message.lower() and 
                                "timeout" not in message.lower() and 
                                "http" not in message.lower())
